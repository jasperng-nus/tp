    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL,
                        PREFIX_STARTDATE, PREFIX_ENDDATE, PREFIX_TAG);
        ...
        if (argMultimap.getValue(PREFIX_STARTDATE).isPresent()) {
            editCompanyDescriptor.setStartDate(ParserUtil.parseDate(argMultimap.getValue(PREFIX_STARTDATE).get()));
        }
        if (argMultimap.getValue(PREFIX_ENDDATE).isPresent()) {
            editCompanyDescriptor.setEndDate(ParserUtil.parseDate(argMultimap.getValue(PREFIX_ENDDATE).get()));
        }
